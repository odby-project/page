        ...
        <Stack width="80vw" direction="row" justifyContent="space-between">
          ...
          <Stack direction="row" justifyContent="flex-end" spacing={1}>
            <Button sx={{ minWidth: 0 }}>
              <img src={openSeaIcon} alt="" onClick={handleOpensea} />
            </Button>
            <IconButton
            ...
            <IconButton
              ...
              onClick={() =>
                window.open('https://www.instagram.com/_odby/', '_blank')
              }
            >
            ...
            <Button
              onClick={() =>
                window.open(
                  'https://www.spatial.io/s/ODBYs-Hi-Fi-Space-6448b78b4ed63407fd6fe82c?share=5487205696407549449',
                  '_blank'
                )
              }
            >
              <img src={spatialIcon} alt="" width="30px" />
            </Button>
          </Stack>
        </Stack>
      )}
          ...
          {isMobile ? (
            <Stack direction="row" justifyContent="flex-end">
              <Stack direction="row" spacing={3}>
                <img src={artCouncil} alt="" height="30px" />
                <img src={retro} alt="" height="30px" />
                <img src={seoulLogo} alt="" height="30px" />
              </Stack>
            </Stack>
          ) : (
            <Stack direction="row" justifyContent="space-between">
              <Stack direction="row">
                ...
                <Stack direction="row">
                  <Button onClick={handleOpensea}>
                    <img src={openSeaIcon} alt="" width="30px" />
                  </Button>
                  <Button
                    onClick={() =>
                      window.open('https://www.twitter.com/oddbody_art')
                    }
                  >
                    <img src={twitterIcon} alt="" width="30px" />
                  </Button>
                  <Button
                    onClick={() =>
                      window.open('https://www.instagram.com/_odby/', '_blank')
                  ...
                  >
                    <img src={instaIcon} alt="" width="30px" />
                  </Button>
                  <Button
                    onClick={() =>
                      window.open(
              ...
              <Stack direction="row" spacing={3}>
                <img src={artCouncil} alt="" width="100px" />
                <img src={retro} alt="" width="100px" />
                <img src={seoulLogo} alt="" />
              </Stack>
            </Stack>
          )}
        </Stack>
