...
const IntroSection: React.FC = () => {
  ...
  return (
    <div id="1" className="App-section">
      ...
      >
        <Box data-aos={isMobile ? 'fade-up' : 'fade-right'} data-aos-delay="50">
          <img
            src={image}
            className="App-logo"
            alt="logo"
        ...
        >
          ...
          <span className="ODBYODD-BODY-OD">
            ...
            {t('page:intro.content8')} <br />
            {t('page:intro.content9')} <br />
            {t('page:intro.content10')} <br />
            {t('page:intro.content11')}
          </span>
        </Stack>
      </Stack>
    </div>
